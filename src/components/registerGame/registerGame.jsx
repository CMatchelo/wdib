...
import './styles.css'
import doubleArrow from '../../img/doubleArrowIcon.png'

function CreateGame() {
    const { user, user2, games, setGames } = useCurrentUser();
    ...
    return (
        <>
            ...
            <div className="registerArea" id="registerArea">
                {user && (
                    <>
                        <div onClick={showRegister} className="titleRegister">
                            <div><span>Didn't find a game?</span></div>
                            <div><span>Register here</span></div>
                            <button><img src={doubleArrow} alt="Open register" /></button>
                        </div>
                        <div id="registerForm" className={`toggle-div ${active ? "active" : ""}`}>
                            ...
                            <div className="registerSend">
                                <button className="gameRegisterBtn" onClick={createGame}>Register</button>
                            </div>
                        </div>
                    </>
                )}
